...
# Create dataloaders
trainloader = DataLoader(video_train, batch_size=16, shuffle=True, num_workers=8)
valloader = DataLoader(video_val, batch_size=16, shuffle=False, num_workers=8)
testloader = DataLoader(video_test, batch_size=16, shuffle=False, num_workers=8)
...
for epoch in range(num_epochs):
    ...
    for i, (inputs, labels) in enumerate(trainloader):
        ...
        # Step size 4
        if (i + 1) % 2 == 0 or i == len(trainloader) - 1: 
            optimizer.step()
            optimizer.zero_grad()
